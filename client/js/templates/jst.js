...
var __t, __p = '', __e = _.escape;
with (obj) {
__p += '<span class="logo">wren</span><aside class="live_data hidden"><aside class="live_data_value"></aside><aside class="live_data_currency"><aside class="currency">USD</aside><aside class="per_unit"><span class="per">per</span>BTC</aside></aside></aside>';
